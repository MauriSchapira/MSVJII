...
Shader "ArrowShader"
{
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			dither21 = step( dither21, saturate( ( sin( ( temp_output_3_0 + mulTime7 ) ) + -0.57 + sin( ( temp_output_3_0 + ( mulTime7 * 0.53 ) ) ) ) ) );
			o.Alpha = dither21;
		}
...
/*ASEBEGIN
Version=18900
658;12;941;1007;713.2036;282.1607;1.524483;True;False
...
Node;AmplifyShaderEditor.DitheringNode;21;126.2294,556.8182;Inherit;False;1;False;4;0;FLOAT;0;False;1;SAMPLER2D;;False;2;FLOAT4;0,0,0,0;False;3;SAMPLERSTATE;;False;1;FLOAT;0
...
ASEEND*/
//CHKSM=3E3C691AB4DDD84DBD6AA160F8B6C26F6C8C2CEC